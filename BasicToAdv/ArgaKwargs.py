# store many argument without specifying the number
# """
...
# pass a non-key worded, variable-length argument list.
#
...
# pass a keyword, variable-length argument list. We use the name kwargs
# with the double star. The
# reason is that the double star allows us to pass through keyword
...
# to the value that we pass alongside it. That is why when we iterate
# over the kwargs there does’t seem to be any order in which they were
# printed out.
...
#
#
# a = {'A keyword': 'argument is where you provide ',
#      'variable': 'a name to the variable',
#      'as you': 'yourself', 'hello': 'greeting'}
#
# kww(**a)
